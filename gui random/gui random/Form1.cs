    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                imgs.Add(Image.FromFile(@"C:\Users\tncj5\OneDrive\Desktop\Funny League Champs\" + Champs[index] + ".png"));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (b2 == 0)
            {
                Image no = Image.FromFile(@"C:\Users\tncj5\OneDrive\Desktop\Funny League Champs\lane.png");
                button2.Image = no;
                b2 = 1;
            }
            else if (b2 == 1)
            {
                Image x = Image.FromFile(@"C:\Users\tncj5\OneDrive\Desktop\Funny League Champs\Dane.png");
                button2.Image = x;
                b2 = 2;
            }
            else if (b2 == 2) 
            {
                Image y = Image.FromFile(@"C:\Users\tncj5\OneDrive\Desktop\Funny League Champs\Bane.png");
                button2.Image = y;
                b2 = 3;
            }
            else if (b2 == 3)
            {
                Image z = Image.FromFile(@"C:\Users\tncj5\OneDrive\Desktop\Funny League Champs\kane.png");
                button2.Image = z;
                b2 = 0;
            }
